...
* Quiénes son los principales usuarios de producto.
  Este producto está hecho para todas aquellos jóvenes que deseen implementar en sus conversaciones diarias textos cifrados para mantener una privacidad en otro nivel. 

* Cuáles son los objetivos de estos usuarios en relación con tu producto.
  Obtener el placer y diversión de sorprender a sus amigos con letras ordenadas sin un sentido aparente pero con gran significado. Pasar un rato agradable en pocas palabras.

* Cómo crees que el producto que estás creando está resolviendo sus problemas.
  Más que resolver problemas, este producto, es una aplicación de ocio. Es una aplicación sencilla con pasos simples que en cualquier momento y lugar puedes ingresar y hacer uso de ella.
